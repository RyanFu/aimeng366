    ...
    class BaseHttpClient
    {
        ...
        public ResponseResult sendRequest(String method, String url, String auth, String reqParams)
        {
            ...
            try
            {
                ...
                myReq.Method = method;
                myReq.Accept = "text/html, application/JSON, */*";
                myReq.ContentType = "application/JSON";
                myReq.Headers.Add("Charset", CHARSET);
                ...
                if (method == "POST")
                {
                    ...
                    //byte[] bs = Encoding.ASCII.GetBytes(HttpUtility.UrlEncode(reqParams, Encoding.GetEncoding("UTF-8")));
