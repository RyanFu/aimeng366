...
namespace Ezhu.AutoUpdater.UI
{
    public partial class DownFileProcess : WindowBase
    {
        ...
        public DownFileProcess(string downUrl, string updateFileDir, string appDir, string appName, string appVersion, string desc, string callExeName)
        {
            InitializeComponent();
            this.Loaded += (sl, el) =>
            {
            ...
            this.downUrl = System.Text.Encoding.UTF8.GetString(Convert.FromBase64String(downUrl));
