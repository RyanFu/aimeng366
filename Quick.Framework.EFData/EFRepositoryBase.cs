...
namespace Quick.Framework.EFData
{
    ...
    public abstract class EFRepositoryBase<TEntity, TKey> : IRepository<TEntity, TKey> where TEntity : EntityBase<TKey>
    {
        ...
        /// <param name="saveNow"> 是否执行保存 </param>
        /// <returns> 操作影响的行数 </returns>
        public virtual int Delete(TKey id, bool saveNow = true, bool validateOnSaveEnabled = false)
        {
        ...
        /// </summary>
        /// <param name="o"></param>
        public virtual int Destroy(TKey key, bool saveNow = true, bool validateOnSaveEnabled = true)
        {
